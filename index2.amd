...
## 1.2. Управление геокодированными объектами. 
Универсальная геокатегория 
...
![](https://github.com/citoruspm/GeoData/blob/master/ris1.png?raw=true "Рисунок 1 – Универсальная геокатегория")
...
Для быстрого возврата к маркеру объекта предназначена кнопка **Цель** ![](https://github.com/citoruspm/GeoData/blob/master/1.png?raw=true), которая расположена в левой части карты.
...
![](https://github.com/citoruspm/GeoData/blob/master/ris2.png?raw=true "Рисунок 2 – Область координат объекта")
...
Чтобы редактировать фигуру с помощью карты, в левой части карты нажмите на кнопку **Свернуть/Развернуть** ![](https://github.com/citoruspm/GeoData/blob/master/4.png?raw=true). Поверх карты отобразятся инструменты визуального редактора (рис. 3).
...
![](https://github.com/citoruspm/GeoData/blob/master/ris3.png?raw=true "Рисунок 3 – Перемещение маркера")

Рисунок 3 – Перемещение маркера

Если из точки следует сделать линию, добавьте на карту новую точку. Для этого нажмите на кнопку ![](https://github.com/citoruspm/GeoData/blob/master/7.png?raw=true). Указатель мыши преобразится в маркер (рис. 4). Установите данный маркер щелчком мыши на требуемом месте карты. От первого маркера до второго будет прорисована линия.

![](https://github.com/citoruspm/GeoData/blob/master/ris4.png?raw=true "Рисунок 4 – Установка маркера")
...
![](https://github.com/citoruspm/GeoData/blob/master/ris5.png?raw=true "Рисунок 5 – Прорисовка полигона")
...
1.  Нажмите правой клавишей мыши на кнопку ![](https://github.com/citoruspm/GeoData/blob/master/8.png?raw=true), которая расположена слева от требуемой координаты. Например, если новую точку следует добавить между первой и второй координатой, нажмите на кнопку ![](https://github.com/citoruspm/GeoData/blob/master/8.png?raw=true), расположенную слева от первой координаты (рис. 6). Затем выполните команду одну из следующих команд контекстного меню:
...
![](https://github.com/citoruspm/GeoData/blob/master/ris6.png?raw=true "Рисунок 6 – Добавление координаты")

Рисунок 6 – Добавление координаты

2.  Нажмите левой клавишей мыши на кнопку ![](https://github.com/citoruspm/GeoData/blob/master/8.png?raw=true), которая расположена слева от требуемой координаты. Ниже добавится новая координата, в полях **Широта** и **Долгота** которой будут указаны градусы (целые числа до запятой) из выбранной координаты (рис. 7).

![](https://github.com/citoruspm/GeoData/blob/master/ris7.png?raw=true "Рисунок 7 – Строка новой координаты")
...
<a name="Экспортимпорт-геоданных-объекта"></a>
### Экспорт/импорт геоданных объекта

Если требуется сохранить геоданные, которые содержатся в универсальной геокатегории (например, чтобы перенести их в универсальную геокатегорию другого объекта), нажмите на кнопку **Скопировать отрисованный GeoJSON слоя в буфер обмена** ![](https://github.com/citoruspm/GeoData/blob/master/9.png?raw=true) (рис. 8).
...
![](https://github.com/citoruspm/GeoData/blob/master/ris8.png?raw=true "Рисунок 8 – Инструменты для экспорта/импорта геоданных объекта")

Рисунок 8 – Инструменты для экспорта/импорта геоданных объекта
<a name="Работа-с-картографическими-слоями"></a>
## 1.3. Работа с картографическими слоями
...
<a name="Порядок-действий-при-создании-группыслоя"></a>
...
<a name="Создание-группы-слоевкартографического-слоя"></a>
...
![](https://raw.githubusercontent.com/citoruspm/GeoData/master/ris9.png "Рисунок 9 – Создание картографического слоя")
...
![](https://github.com/citoruspm/GeoData/blob/master/ris10.png?raw=true "Рисунок 10 – Окно **Выбор типа создаваемого объекта**")
...
![](https://github.com/citoruspm/GeoData/blob/master/ris11.png?raw=true "Рисунок 11 – Карточка нового объекта типа **Картографический слой**")
...
![](https://github.com/citoruspm/GeoData/blob/master/ris12.png?raw=true "Рисунок 12 – Кнопка **Карта**")
...
![](https://github.com/citoruspm/GeoData/blob/master/ris13.png?raw=true "Рисунок 13 – Подтверждение действия")
...
![](https://github.com/citoruspm/GeoData/blob/master/ris14.png?raw=true "Рисунок 14 – Окно **Выбор контейнера слоя**")
...
![](https://github.com/citoruspm/GeoData/blob/master/ris15.png?raw=true "Рисунок 15 – Окно **Выбор типа**")
...
![](https://github.com/citoruspm/GeoData/blob/master/ris16.png?raw=true "Рисунок 16 – Окно **Сопоставление полей**")
...
![](https://github.com/citoruspm/GeoData/blob/master/ris16_1.png?raw=true "Рисунок 17 – Системное имя типа")

Рисунок 17 – Системное имя типа

2.  Укажите, в какое свойство типа следует поместить геоданные из файла (рис. 18). Для этого добавьте в таблицу новую строку нажатием на кнопку ![](https://github.com/citoruspm/GeoData/blob/master/12.png?raw=true), которая расположена над таблицей, и щелкните по данной строке мышью, чтобы активировать свойства файла и типа. Затем в свойствах типа выберите свойство **object > geo > geoJSON**, а в свойствах файла – свойство **geometry**.

![](https://github.com/citoruspm/GeoData/blob/master/ris16_2.png?raw=true "Рисунок 18 – Геоданные")
...
![](https://github.com/citoruspm/GeoData/blob/master/ris16_3.png?raw=true "Рисунок 19 – Основные свойства")
...
![](https://github.com/citoruspm/GeoData/blob/master/ris17.png?raw=true "Рисунок 20 – Настройки растрового слоя")
...
![](https://github.com/citoruspm/GeoData/blob/master/ris18.png?raw=true "Рисунок 21 – Контекстное меню")

Рисунок 21 – Контекстное меню

-   В дереве объектов выделите требуемую группу/слой нажатием левой клавиши мыши. В новой вкладке откроется карточка группы/слоя (рис. 22). Чтобы активировать ее поля, на панели инструментов нажмите на кнопку **Редактировать** ![](https://github.com/citoruspm/GeoData/blob/master/13.png?raw=true).

![](https://github.com/citoruspm/GeoData/blob/master/ris19.png?raw=true "Рисунок 22 – Карточка картографического слоя")

Рисунок 22 – Карточка картографического слоя
...
![](https://github.com/citoruspm/GeoData/blob/master/ris20.png?raw=true "Рисунок 23 – Общие поля")

Рисунок 23 – Общие поля
...
![](https://github.com/citoruspm/GeoData/blob/master/ris21.png?raw=true "Рисунок 21 – Настройки векторных слоев")
...
![](https://github.com/citoruspm/GeoData/blob/master/ris22.png?raw=true "Рисунок 25 – Настройки растровых слоев")
...
<a name="Управление-геоданными-на-карте"></a>
## 1.4. Управление геоданными на карте

Чтобы открыть карту, в главном меню системы нажмите на кнопку **Карта** (рис. 26).

![](https://github.com/citoruspm/GeoData/blob/master/ris23.png?raw=true "Рисунок 26 – Кнопка **Карта**")
...
![](https://github.com/citoruspm/GeoData/blob/master/ris24.png?raw=true "Рисунок 27 – Инструменты работы с картой")
...
![](https://github.com/citoruspm/GeoData/blob/master/ris25.png?raw=true "Рисунок 28 – Меню управления геоподосновами")

Рисунок 28 – Меню управления геоподосновами
...
![](https://github.com/citoruspm/GeoData/blob/master/ris26.png?raw=true "Рисунок 29 – Кнопка перехода в меню управления слоями")
...
![](https://github.com/citoruspm/GeoData/blob/master/ris27.png?raw=true "Рисунок 30 – Меню управления слоями")

Рисунок 30 – Меню управления слоями

-   ![](https://github.com/citoruspm/GeoData/blob/master/14.png?raw=true) – координаты точки, на которую указывает курсор на карте (рис. 31).
...
![](https://github.com/citoruspm/GeoData/blob/master/ris28.png?raw=true "Рисунок 31 – Меню управления слоями")
...
![](https://github.com/citoruspm/GeoData/blob/master/ris29.png?raw=true "Рисунок 32 – Таймлайн")
...
2.  Откройте календарь нажатием на кнопку ![](https://github.com/citoruspm/GeoData/blob/master/15.png?raw=true) (рис. 33). Щелчком мыши выберите начальную дату требуемого периода. Затем, удерживая на клавиатуре клавишу **Shift**, щелчком мыши отметьте конечную дату требуемого периода.
...
![](https://github.com/citoruspm/GeoData/blob/master/ris30.png?raw=true "Рисунок 33 – Календарь")

Рисунок 33 – Календарь
<a name="Меню-инструментов"></a>
### Меню инструментов

Меню инструментов разворачивается при нажатии на кнопку ![](https://github.com/citoruspm/GeoData/blob/master/4.png?raw=true) (рис. 34).
...
![](https://github.com/citoruspm/GeoData/blob/master/ris31.png?raw=true "Рисунок 34 – Меню инструментов")
...
![](https://github.com/citoruspm/GeoData/blob/master/ris32.png?raw=true "Рисунок 35 – Линейка")
...
![](https://github.com/citoruspm/GeoData/blob/master/ris33.png?raw=true "Рисунок 36 – Полигон")

Рисунок 36 – Полигон

Если фигура объекта соответствует требованиям, перейдите в его карточку.

Если нарисованную фигуру полигона требуется редактировать, нажмите на кнопку ![](https://github.com/citoruspm/GeoData/blob/master/6.png?raw=true). На фигуре отобразятся крайние и промежуточные точки, которые можно перемещать с помощью мыши (рис. 37). Установите точки в требуемое положение и нажмите на кнопку **Сохранить**, которая отображается под кнопкой ![](https://github.com/citoruspm/GeoData/blob/master/6.png?raw=true). Затем перейдите в карточку полигона, как это описано выше.

![](https://github.com/citoruspm/GeoData/blob/master/ris34.png?raw=true "Рисунок 37 – Режим редактирования полигона")

Рисунок 37 – Режим редактирования полигона

Чтобы нарисовать линию, нажмите на кнопку ![](https://github.com/citoruspm/GeoData/blob/master/18.png?raw=true). Щелчками мыши по карте установите крайние точки линии. Затем нажмите повторно на конечную точку фигуры. Над крайней точкой отобразится маркер со всплывающим окном, в котором содержится ссылка для перехода в карточку нарисованного объекта (рис. 38).

![](https://github.com/citoruspm/GeoData/blob/master/ris35.png?raw=true "Рисунок 38 – Линия")

Рисунок 38 – Линия

Если фигура объекта соответствует требованиям, перейдите в карточку объекта.

Если фигуру объекта требуется редактировать, нажмите на кнопку ![](https://github.com/citoruspm/GeoData/blob/master/6.png?raw=true). На линии отобразятся крайние и промежуточные точки, которые можно перемещать с помощью мыши (рис. 39). Установите точки в требуемое положение и нажмите на кнопку **Сохранить**, которая отображается под кнопкой ![](https://github.com/citoruspm/GeoData/blob/master/6.png?raw=true). Затем перейдите в карточку нарисованного объекта, как это описано выше.

![](https://github.com/citoruspm/GeoData/blob/master/ris36.png?raw=true "Рисунок 39 – Режим редактирования линии")
...
Чтобы распечатать текущий фрагмент карты, нажмите на кнопку ![](https://github.com/citoruspm/GeoData/blob/master/19.png?raw=true), которая расположена под меню инструментов (рис. 40).
...
![](https://github.com/citoruspm/GeoData/blob/master/ris37.png?raw=true "Рисунок 40 – Страница печати")

Рисунок 40 – Страница печати
